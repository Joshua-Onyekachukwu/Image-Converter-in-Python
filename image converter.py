...
input_folder = '../Data Scraping/jpeg images'  # Path to the folder containing JPEG images
output_folder = '../Data Scraping/png2 images'  # Path where PNG images will be saved
